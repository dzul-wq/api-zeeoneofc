...
var creatorList = ['@razorganz','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'razorganz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'razorganz') return res.json(loghandler.invalidKey)
